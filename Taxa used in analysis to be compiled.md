...
> - **In deepbone map, there are three points for this species. Only one is correct. The point near Canberra is obviously wrong. I cannot judge which one of the above two points is correct as the map is in Chinese. Cross-check the data in deepbone and revise those incorrect.**      revised.
...
> - Eday Flagstone Fm.; Orkney Islands, Deerness, Cullister, Mousa, Caithness, Exnaboe, Scotland
...
> - Passage beds and Thurso flagstone group; Nairnshire, Banffshire, Rossshire, Caithness, Orkney, Shetland, Scotland
> - Hemmings, 1978\
> -  The age range in deep bone is Givetian.
